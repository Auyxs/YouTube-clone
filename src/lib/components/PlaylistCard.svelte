...
<div class="card">
    <a href="/playlist/{playlist.name.replace(' ', '_')}" class="video-link text-decoration-none">
        <!-- First Stacked Thumbnail -->
        <div class="position-absolute" style="width: 90%; padding-bottom: 50%; top: -8px; left: 10px;">
            <img src="https://img.youtube.com/vi/{playlist.cover}/hqdefault.jpg" 
                class="card-img-top rounded-3 position-absolute" alt=""
                style="top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;" />
        </div>

        <!-- Second Stacked Thumbnail -->
        <div class="position-absolute" style="width: 95%; padding-bottom: 50%; top: -5px; left: 5px; border: 1px solid white;">
            <img src="https://img.youtube.com/vi/{playlist.cover}/hqdefault.jpg" 
                class="card-img-top rounded-3 position-absolute" alt=""
                style="top: 0; left: 0; width: 100%; height: 100%; object-fit: cover;" />
        ...
        <!-- Main Thumbnail -->
        <div class="position-relative" style="width: 100%; padding-bottom: 56.25%; border: 1px solid white;">
            <img src="https://img.youtube.com/vi/{playlist.cover}/hqdefault.jpg" 
